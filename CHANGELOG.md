...
- add howeverpromptfoo projectization toolkit (brand assets, env templates, governance docs)
- add provider base URL customization for however openai/ollama environments
- add redteam custom plugin registry and extension assertion namespace
